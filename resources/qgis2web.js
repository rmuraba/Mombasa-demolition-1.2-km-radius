...
map.getView().fit([4413636.615215, -453106.255988, 4419604.254361, -449450.060071], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">1.2 km radius map </h2>';
        return titleElement;
    })(),
